...
useEffect(() => {
    ...
    <main>
      <form
        ...
        className="py-2 px-4 rounded-md w-[90%] mt-[5%]
         ml-[5%] md:w-[40%] md:ml-[25%] grid grid-rows-2 gap-2"
      >
        
                    <Link href={`/account/forms/${listId}`}><ChevronLeft color="black" size={30}/></Link> 
  ...
  className=" text-black text-[100px] font-extrabold outline-0  w-full"
  value={price}
  onChange={(e) => {
