...
async function Slip({list,listItems, listId}) {
   ...
   const savedPercentage = Number(list.money_left / list.list_budget * 100).toFixed(2)
    return (
        <div className="mt-10 w-[90%] mx-[5%] text-black">
            <div className="flex justify-center"> <Logo/></div>
            <p className="text-center text-sm">WhatsApp: +27 72 124 7120</p>
            <h2 className=" text-center ">Your digital Grocery
            ...
            <ul key={listitem.id} >
                <li className="flex  text-sm py-1 ">
            ...
            <div className="w-[90%] mx-[5%]">
                <h1 className="text-2xl text-black"> You can now go to the till</h1>
                <table>
                   <thead>
          <tr className="text-left">
         
            <th  className=" p-2 text-black ">Money Spent (Approx)</th>
        ...
        <tbody>
            <tr>
                 ...
                 <td className=" p-2 text-5xl text-black">R{list.money_spent}</td>
   ...
   grid gap-6 mt-11 mx-4 `}>
     <button
      ...
      className="h-10 min-w-[300px] px-2  bg-amber-700 active:bg-gray-600 cursor-pointer  rounded-lg text-[#04284B]
    ...
    <button
      ...
      cursor-pointer border bg-transparent text-black border-[#04284B] active:bg-[#A2B06D]  font-semibold hover:opacity-70 transition-all"
    >
