...
const features = [
  {
    ...
    description:
      "Get personalized store recommendations based on exactly what is in grocery list, and your location, so you shop where it makes the most sense.",
    id: 1,
  },
  // {
  ...
  },
  {
    ...
    description:
      "No more jumping between apps. Grossary helps you create grocery lists, store loyalty cards, track your spending in real-time, and find specials for your specific grocery items with Grossary Plus, so you can focus on shopping, not searching.",
    id: 4,
  },
];
...
const data = [
  {
    ...
    explanation: 'Create your grocery list.',
    id: 1,
  },
  {
  ...
  },
  {
    ...
    explanation: 'Instantly see the top 2+ nearby stores that match your list and location.',
    id: 3,
  },
    ...
    <>
      <main className="p-6 relative my-3">
        <section className="w-[90%] lg:w-[30%] mx-auto text-left my-12 mt-20">
          ...
          <p className="text-xl ">
            No more flipping through ClicFlyer or each store catalogue after catalogue.
          </p>
          ...
          <div className="mt-6">
            <Link href="/auth/signup">
              <SignUpButton>
                <span className="px-10">Claim 7-day Free Trial</span>
              </SignUpButton>
            </Link>
          </div>
        </section>
...
<div className="mb-10 lg:w-[60%] lg:ml-[20%] w-[90%] ml-[5%] py-11 ">
        ...
        <blockquote className="border-l-4 border-[#1EC677] pl-4 italic text-gray-700 text-lg">
          “I used to flip through ClicFlyer and store catalogues every week. Now i just create my grocery list on 
          grossary and grossary plus just where i can get what on my list at the lowest price and it’s always spot on with prices.
           Love the time and money I save!”
        </blockquote>
        <p className="mt-2 text-sm text-gray-600">— Zinhle., Corporate Girlie</p>
...
function GrossaryPlusFeature({ content }) {
  return (
    <div className={`bg-[#0B2E1E] rounded-lg p-6 w-full max-w-[350px] h-[200px] `}>
      <h2 className="text-[#1EC677] text-xl font-semibold mb-2 text-center">
        {content.heading}
      </h2>
