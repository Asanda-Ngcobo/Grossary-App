...
function TestimonialBunner({usertestimonial}) {
    return (
        <div className="text-white h-[fit] lg:h-[30vh] lg:w-[50%] lg:mx-auto">
            <blockquote className="border-l-4 border-[#A2B06D] pl-4 italic text-gray-700 text-lg">“{usertestimonial.testimonial}“</blockquote>
