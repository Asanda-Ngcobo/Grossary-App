...
function MainBunner({children}) {
    return (
        <div className={`${MainFont.className} bg-[#04284B] w-[90%] h-[350px] ml-[5%] mt-[450px] absolute rounded-2xl sm:w-[80%]
         sm:h-[320] sm:mt-[300px] md:mt-[600px] md:w-[80%] md:h-[300px] md:ml-[5%]
